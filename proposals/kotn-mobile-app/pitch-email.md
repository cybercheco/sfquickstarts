...
> One-page outreach email. Voice: calm, specific, on-brand. Length:
> ~270 words. Designed to read on a phone in under a minute.
>
> The mockup links work today (raw.githack proxies the branch). When
> the work merges to `master`, swap the branch name in the URLs.

## Subject line — pick one

1. A mobile app for the brand that already tells the truth.
2. From the Nile to your customers' pocket.
3. I built a Kotn mockup. Five-minute look — no pitch deck required.

## Recipient

Rami Helali (co-founder & CEO) is the natural first recipient. Mackenzie
Yeates (co-founder & creative director) is a strong second / cc.
...
- Your name
- Your phone or scheduling link (if helpful — Calendly / Cal.com)
- Optionally: cc your designer or PM if they led the mockups
- Confirm the Rami / Mackenzie email addresses via a recent press
  contact or LinkedIn intro
